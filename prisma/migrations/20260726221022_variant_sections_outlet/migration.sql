...
-- CreateTable
CREATE TABLE "_VariantSections" (
    "A" TEXT NOT NULL,
    "B" TEXT NOT NULL,

    CONSTRAINT "_VariantSections_AB_pkey" PRIMARY KEY ("A","B")
);
...
-- CreateIndex
CREATE INDEX "_VariantSections_B_index" ON "_VariantSections"("B");
...
-- AddForeignKey
ALTER TABLE "_VariantSections" ADD CONSTRAINT "_VariantSections_A_fkey" FOREIGN KEY ("A") REFERENCES "product_variants"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "_VariantSections" ADD CONSTRAINT "_VariantSections_B_fkey" FOREIGN KEY ("B") REFERENCES "sections"("id") ON DELETE CASCADE ON UPDATE CASCADE;
