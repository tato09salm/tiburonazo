          ...
          <button
            onClick={() => {
              ...
              addItem({
                ...
                title: product.title,
                slug: product.slug,
                image: (selectedVariant as any).images?.[0]?.productImage?.url || (selectedVariant as any).productImage?.url || product.images[0]?.url || "/placeholder4.png",
                color: selectedVariant.color?.name || null,
                size: selectedVariant.size?.label || null,
                estampado: (selectedVariant as any).estampado ?? selectedVariant.diseno ?? null,
                diseno: (selectedVariant as any).estampado ?? selectedVariant.diseno ?? null,
