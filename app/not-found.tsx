...
export default function NotFound() {
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-bg to-light">
      <div className="text-center px-4">
        <div className="text-9xl font-display text-primary font-bold opacity-20 select-none">404</div>
